...
const SEARCH_DATA = [
  ...
  { title: '6. Sınıf Sosyal Bilgiler', description: 'Birlikte Yaşamak, Evimiz Dünya, Ortak Mirasımız, Yaşayan Demokrasi ve diğer üniteler.', href: 'egitim.html', category: 'Eğitim', path: 'Eğitim / 6. Sınıf', icon: 'book', keywords: '6 sınıf sosyal bilgiler roller ortak miras ekonomi demokrasi vatandaşlık telif patent' },
